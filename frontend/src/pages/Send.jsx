        ...
        {!sent ? (
          <form onSubmit={submit} className="space-y-3">
            ...
            <div className="flex gap-3">
              <button className="px-4 py-2 rounded-full bg-gradient-to-r from-softpink to-coral text-white">
                Send
              </button>
          ...
          <div className="space-y-4">
            ...
            <Link
              to="/register"
              className="inline-block px-4 py-2 rounded-full bg-gradient-to-r from-softpink to-coral text-white"
            >
              Create an account
            </Link>
          </div>
