    ...
    <div className='min-h-screen flex items-center justify-center relative'>
      <div className='card w-full max-w-md fade-in'>
        ...
        <form onSubmit={submit} className='space-y-3'>
          <input className='w-full p-3 rounded-lg border' placeholder='Choose a username' value={username} onChange={e=>setUsername(e.target.value)} />
          ...
          <button className='w-full py-3 rounded-full bg-gradient-to-r from-softpink to-coral text-white'>Create account</button>
        </form>
      </div>
    </div>
  )
